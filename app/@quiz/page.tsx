...
export default function Quiz() {
  ...
  return (
    <section className="flex flex-col justify-center items-center p-20 ">
      {questions?.length ? (
        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-customGreen md:text-5xl lg:text-6xl dark:text-white">
          Question No{" "}
          <span className="text-blue-600 dark:text-blue-500 text-white">
      ...
      {!questions?.length && !loading && (
        <div className="flex flex-col justify-center items-center">
          ...
          <button
            ...
            className="bg-[#1de9b6] hover:bg-gray-100 my-10 text-gray-800 font-semibold py-2 px-10 border border-gray-400 rounded shadow"
            >
            Start Over
          </button>
        </div>
  ...
  <section className="my-10 p-10 w-[90%] rounded-lg flex flex-col justify-center items-center border border-white">
<h4 className="mb-4 text-center text-xl font-extrabold leading-none tracking-tight md:text-2xl lg:text-4xl text-white">
            ...
            {questions[0].answers.map((e:string) => {
              return (
                <button
                  ...
                  className={cn(
                    "w-[40%] my-4 bg-[#1de9b6] hover:bg-white hover:text-black text-black font-semibold py-4 px-4 rounded-lg",
                    {
          ...
          <button
            onClick={handleNext}
            className="bg-[#1de9b6] hover:bg-white text-gray-800 hover:text-[#1de9b6] font-semibold py-2 px-10 border border-gray-400 rounded"
            >
            Next
          </button>
        </section>
